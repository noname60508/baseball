...
class CommonMigration
{
     ...
     * 檔案上傳共用模組欄位
     */
    public static function dataUpload(&$table, string $foreignKeyName): void
    {
        $table->integer('photo_or_File')->nullable()->comment('1:照片、2:檔案');
        $table->integer('category')->comment('類別:[1:施工照片、2:試水照片]');
        ...
        $table->double('fileSize', 38, 0)->nullable()->comment('檔案大小(MB)');
